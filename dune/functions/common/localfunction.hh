...
public:
  ...
  {
    static_assert(Dune::Functions::Concept::LocalFunction<F, Range, Domain, LocalContext>, "Trying to construct a LocalFunction from type that does not model the LocalFunction concept");
  }
