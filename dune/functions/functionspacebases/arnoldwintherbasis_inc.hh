...
#ifndef DUNE_FUNCTIONS_FUNCTIONSPACEBASES_ARNOLDWINTHERBASIS_INC_HH
#define DUNE_FUNCTIONS_FUNCTIONSPACEBASES_ARNOLDWINTHERBASIS_INC_HH
  ...
  namespace Impl
  {
        ...
        typename Traits::DomainType const& in, std::vector<typename Traits::RangeType>& out) const
    {
      ...
      if constexpr (k == 2) {
        ...
        // 0th basis function
        *(iter++) =
            sym<Range>(x * x * (2 * x + 9 * y - 3) + y * (y * (18 - 10 * y) - 9) + 1,
    ...
    void ArnoldWintherReferenceLocalBasis<D, R, dim, k>::evaluateDivergence(
        typename Traits::DomainType const& in,
...
#endif // DUNE_FUNCTIONS_FUNCTIONSPACEBASES_ARNOLDWINTHERBASIS_INC_HH
