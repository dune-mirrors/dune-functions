...
class DynamicPowerNodeIndexSet;
...
class DynamicPowerPreBasis
{
  ...
  friend class DynamicPowerNodeIndexSet;
...
public:
  ...
  using IndexSet = DynamicPowerNodeIndexSet<DynamicPowerPreBasis, IMS>;
...
public:
  ...
  DynamicPowerNodeIndexSet (const PreBasis& preBasis)
    : preBasis_(&preBasis)
    , children_(preBasis.children_)
