...
/** \brief Concepts used throughout lineartransformedlocalfiniteelement.hh
 */
namespace Dune::Functions {
namespace Concept::Impl {

  /** \brief A basis is an H2Basis, if it
   * - allows evaluation of the Hessians
   * - exports a corresponding Type HessianType via its Traits
   */
  struct H2Basis {
    template <class LB>
...
namespace Impl {
  /**
   * \brief Helper structure to deduce the type of Hessians. Defaults to void if not exported by
   */
  // LocalBasis
  ...
  /**
   *\brief Structure to deduce whether a FiniteElement is a Transformed finite element
   */
  // forward declaration
