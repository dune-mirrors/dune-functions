...
public:
  ...
  {
    static_assert(Dune::Functions::Concept::GridFunction<F, Range, Domain, EntitySet>, "Trying to construct a GridFunction from type that does not model the GridFunction concept");
  }
